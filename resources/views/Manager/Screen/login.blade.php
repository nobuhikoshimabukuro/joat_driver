@extends('Manager.Common.non_header_layouts_app')
...
<div class="container">
    ...
    <div class="contents row justify-content-center p-0">
      ...
      <div class="col-xxl-5 col-xl-6 col-lg-7 col-md-8 col-sm-10 col-11">
        ...
        <form action="{{ route('manager.login_check') }}" id='login_form' method="post" class="login-container" enctype="multipart/form-data">
          @csrf
          
            <label class="form-label">user_cd</label>
            <input type="text" name="user_cd"
            class="form-control {{ isset(session('errors')->user_cd) ? 'is-invalid' : '' }}"
            value="{{ old('user_cd') }}"
            maxlength="10"
            >          

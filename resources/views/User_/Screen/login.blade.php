@extends('User.Common.non_header_layouts_app')
...
<div class="container">
    ...
    <div class="contents row justify-content-center p-0">
      ...
      <div class="col-xxl-5 col-xl-6 col-lg-7 col-md-8 col-sm-10 col-11">
        ...
        <form action="{{ route('user.login_check') }}" id='login_form' method="post" class="login-container" enctype="multipart/form-data">
          @csrf
